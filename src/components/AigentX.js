   ...
   useEffect(() => {
    ...
    return (
      <div className="App bg-[#17191B]">
        {/* Modal */}
        {showModal == 1 ? (<div className='fixed fadeIn left-0 top-0 w-full h-full bg-[#000000bb] z-[1]'>
        <div className='relative flex flex-col justify-center w-full h-full text-white'>
            <div className='text-xl text text-md'>You want to delete the bot?</div>
            <div className='flex flex-row justify-center gap-3 mt-7'>
                ...
                <button className='bg-[#ED1522] rounded-xl py-2 px-9'>Delete</button>
            </div>
            </div>
        </div>) : null}
        <Navbar />
